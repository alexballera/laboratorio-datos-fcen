...
#%%
np.random.seed(0);
X = np.random.standard_normal((75 ,2));
X[:25 ,0] += 3; # a los 1ros 25 en la coordenada 0 sumar 3
X[:25 ,1] -= 4; # a los 1ros 25 en la coordenada 1 restar 4
X[25:50 ,1] += 10; # los puntos de 25 a 50 en la coordenada 1 sumar 10
X[50: ,0] +=6; # a los últimos 50 de coord 0 sumar 6
X[50: ,1] +=6; # a los últimos 50 de coord 1 sumar 6
#%% Visualizamos los datos
fig , ax = plt.subplots (1, 1, figsize =(8 ,8))
ax.scatter(X[:,0], X[:,1])
#%% KMeans k = 2
# n_init se inicializa 20 veces
# n_clusters = cantidad de clusters = k = 2
...
#%% DBSCAN
# eps epsilon: La distancia máxima entre dos muestras
# min_samples, default=5 El número de muestras (o peso total) en un
# vecindario para un punto a ser considerado como un punto central

dbclust = DBSCAN(eps=1, min_samples=7)
...
# Visualizamos AgglomerativeClustering
fig , ax = plt.subplots(figsize =(8 ,8))
ax.scatter(X[:,0], X[:,1], c=hc_comp.labels_)
ax.set_title("Agglomerative Clustering Results");
#%% AgglomerativeClustering distance_threshold =None, n_clusters=3
HClust = AgglomerativeClustering
